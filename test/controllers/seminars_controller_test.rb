...
class SeminarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seminar" do
    assert_difference('Seminar.count') do
      post seminars_url, params: { seminar: { assignments: @seminar.assignments, description: @seminar.description, title: @seminar.title } }
    end
  ...
  test "should update seminar" do
    patch seminar_url(@seminar), params: { seminar: { assignments: @seminar.assignments, description: @seminar.description, title: @seminar.title } }
